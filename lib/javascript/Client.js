...
function hipmer(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_hipmer_hpc = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "hipmer.run_hipmer_hpc",
